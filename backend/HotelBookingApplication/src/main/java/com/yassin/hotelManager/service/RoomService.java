...
import com.yassin.hotelManager.exception.InternalServerException;
import com.yassin.hotelManager.exception.ResourceNotFoundException;
import com.yassin.hotelManager.repository.RoomRepository;
...
public class RoomService implements IRoomService {
    ...
    public Room addNewRoom(MultipartFile file, String roomType, BigDecimal price) throws SQLException, IOException {
        ...
        room.setPrice(price);
        room.setCapacity(2); // default, can be passed later
        room.setDescription("Standard room"); // default
        if (!file.isEmpty()) {
